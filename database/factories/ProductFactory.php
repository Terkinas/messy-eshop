...
class ProductFactory extends Factory
{
    ...
    public function definition()
    {
        ...
        $whatProduct = mt_rand(1, 2);
        if ($whatProduct == 1) {
            $imageArray = [
                'Mango-Raspberry-Icecream-E-Liquid-by-Double-Drip_540x.jpg',
                'vanilla-E-Liquid-by-VS-Fifty-50_540x.jpg',
                'Mixed-Berries-Nic-Salt-by-Fruitz_540x.jpg',
                'CLUB-JUICE-CHERRY-2_540x.jpg',
                'berry-fruits-E-Liquid-by-VS-Fifty-50_540x.jpg',
                'Vimto-Crush-Nic-Salt-E-Liquid-by-Doozy_20982063-e4a2-41ea-b2a3-71c826b4f445_540x.jpg',
                'Strawberry-Nic-Salt-by-Fruitz_540x.jpg',
                'Mango-_-Passion-Fruit-5050-E-Liquid-by-Just-Juice_540x.jpg',
                'CLUB-JUICE-MENTHOL-2_540x.jpg',
                'cola-fizz-E-Liquid-by-VS-Fifty-50_540x.jpg',
                'Berry-Boomer-Nic-Salt-by-Rad-Salts_1_540x.jpg',
                'Vimto-Breeze-Nic-Salt-by-Rad-Salts_1_540x.jpg',
                'BlueRaspberryE-LiquidbyDoozyVapes_540x.jpg',
                'whoop-strawberry-kiwi-salt-.jpg',
                'whoop-blueberry-salt-.jpg',
                'whoop-melon-salt.jpg',
                'whoop-apple-salt.jpg',
            ];
            ...
            return [
                'name' => 'Vape Liquid ' . $randomNames[rand(0, count($randomNames) - 1)],
