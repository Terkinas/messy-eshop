...
<nav role="navigation" aria-label="{{ __('Pagination Navigation') }}" class="scale-75 sm:scale-90 origin-left flex items-center justify-between">
    <div class="flex justify-between flex-1 hidden">
        ...
        <span class="relative inline-flex items-center px-4 py-2 text-sm font-medium text-gray-500 bg-white border border-gray-300 cursor-default leading-5 rounded">
            <i class="fa-solid fa-caret-left pr-1 text-gray-300"></i>
            {!! __('Back') !!}
        </span>
        @else
        ...
        <a href="{{ $paginator->nextPageUrl() }}" class="relative inline-flex items-center px-4 py-2 ml-3 text-sm font-medium text-gray-700 bg-white border border-gray-300 leading-5 rounded hover:text-gray-500 focus:outline-none focus:ring ring-gray-300 focus:border-blue-300 active:bg-gray-100 active:text-gray-700 transition ease-in-out duration-150">
            {!! __('Next') !!}
            <i class="fa-solid fa-caret-right pl-1 text-gray-300"></i>
        </a>
        @else
        ...
        <div>
            <span class="relative z-0 inline-flex shadow-sm rounded-md">
                ...
                <span aria-current="page">
                    <span class="relative inline-flex items-center px-4 py-2 -ml-px text-sm font-medium text-gray-300 bg-gray-100 border border-gray-300 cursor-default leading-5">{{ $page }}</span>
                </span>
                @else
