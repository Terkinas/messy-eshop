...
<div class="h-fit sm:block max-h-32  sm:w-full mx-auto bg-black my-1 relative overflow-hidden ">
    ...
    <div class="">
        ...
        @else
        <h4 class="text-2xl font-bold text-white absolute w-full text-center h-full flex justify-center top-1/3 uppercase">All products</h4>
        @endif
...
<div class="w-full flex justify-center bg-gray-50 ">
    @if (isset($chosedCategory))
    <form action="{{ route('products.searchCategory', [$chosedCategory]) }}" method="GET" class="scale-90 md:scale-100 p-0 pt-8 sm:p-0 sm:pt-0 sm:mt-8 sm:ml-8 w-full sm:w-1/3">
        @else
